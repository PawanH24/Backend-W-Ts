...
exports.generateForgotPasswordOtpHtml = exports.generateHostBookingNotificationHtml = exports.generateBookingCreatedHtml = exports.generateAccountLoggedInHtml = exports.generateAccountCreatedHtml = void 0;
...
const generateAccountCreatedHtml = ({ fullName, email, created_at, agent, }) => {
...
const generateAccountLoggedInHtml = ({ fullName, email, logged_in_at, agent, }) => {
...
exports.generateAccountLoggedInHtml = generateAccountLoggedInHtml;
const generateBookingCreatedHtml = ({ guestName, propertyName, propertyAddress, bookingReference, checkIn, checkOut, totalPrice, }) => {
    return `
<!DOCTYPE html>
<html>
<head>
...
exports.generateBookingCreatedHtml = generateBookingCreatedHtml;
const generateHostBookingNotificationHtml = ({ hostName, guestName, guestEmail, propertyName, bookingReference, checkIn, checkOut, totalPrice, }) => {
    return `
<!DOCTYPE html>
<html>
<head>
...
exports.generateHostBookingNotificationHtml = generateHostBookingNotificationHtml;
const generateForgotPasswordOtpHtml = ({ fullName, otp, expiresAt, }) => {
...
exports.generateForgotPasswordOtpHtml = generateForgotPasswordOtpHtml;
//# sourceMappingURL=emailTemplate.utils.js.map